...
%    \node [align=center, left] at (-1, 3.5) {$h_{\infty} = \numrange{10}{100}~\si{\watt\per\square\meter\per\kelvin}$, \\ $T_{\infty} = \SI{295}{\kelvin}$};
    ...
    \node [align=center, right] at (1, -1.5) {$h_{\infty} = \numrange{1}{10}~\si{\watt\per\square\meter\per\kelvin}$};
    % Tank wall to ullage
    \draw [->, thick] (0, 1) -- (1, 1);
    \node [align=center, right] at (1, 1) {$h_{\infty} = \numrange{1}{10}~\si{\watt\per\square\meter\per\kelvin}$};
    % Tank wall to top propellant
    \draw [->, thick] (0, 3.5) -- (1, 3.5);
    \node [align=center, right] at (1, 3.5) {$h_{\infty} = \numrange{1}{10}~\si{\watt\per\square\meter\per\kelvin}$};
